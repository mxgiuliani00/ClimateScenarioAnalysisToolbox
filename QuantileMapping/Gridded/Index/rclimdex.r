...
IndicesCalculation <- function(climdexinput) {
  ...
  id1 <- WriteIndice("tx90p", rclimdex.env$parameter$tx90p, file.path, file.prefix, climdexinput, monthly = TRUE, round = 2)
  id2 <- WriteIndice("wsdi", rclimdex.env$parameter$wsdi, file.path, file.prefix, climdexinput)
  id3 <- WriteIndice("csdi", rclimdex.env$parameter$csdi, file.path, file.prefix, climdexinput)
  id4 <- WriteIndice("r95p", rclimdex.env$parameter$r95p, file.path, file.prefix, climdexinput, pcicname = "r95ptot", round = 1)
...
ClimdexInput <- function() {
  ...
  SetDates(rclimdex.env$data, "tmax")
